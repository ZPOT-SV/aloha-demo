    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/70 px-4 py-8 backdrop-blur-sm">
      <div className="mx-auto max-w-lg rounded-[2rem] border border-brand/10 bg-white p-6 shadow-2xl shadow-brand/20">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-4xl font-black text-slate-950">¡Pedido Confirmado!</h1>
          <p className="mt-2 text-sm font-medium text-text-muted">Transacción #{transactionId}</p>
        </div>
        ...
        <div className="mt-6 rounded-[1.5rem] bg-surface p-5 text-center">
          ...
          <p className="mt-3 text-5xl font-black text-highlight">+{animatedTikis}</p>
          <p className="mt-4 text-base font-bold text-slate-950">Tu nuevo saldo: {newBalance} Tikis</p>
        ...
        <div className="mt-6 rounded-[1.5rem] bg-white p-5 text-center shadow-lg shadow-brand/10">
          ...
          <p className="mt-4 text-sm text-text-muted">Mostrá este QR en tienda al recoger tu pedido</p>
        </div>
